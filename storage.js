...
var Than_to_smile = [140000, 0, 0.001, 0];
var Sleep_fire_lotus = [1200000, 0, 0.0009, 0];
var The_ghost_orchid = [15000000, 0, 0.0005, 0];
//143
...
function dispose(name, type) {
    ...
    var b = type;
    if (b == 1 && cash >= 2000) {
        if (combine[a][b] == 0) inform("恭喜，解锁新作物！", 5000);
